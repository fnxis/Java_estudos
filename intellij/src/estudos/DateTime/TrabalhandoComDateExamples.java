...
public class TrabalhandoComDateExamples {
    public static void main(String[] args) throws ParseException {
        ...
        Date y1=sdf.parse("22/02/2007");
        Date y2=sdf2.parse("22/02/2007 13:42:00");
        Date y3=Date.from(Instant.parse("2022-02-22T13:42:00Z"));
